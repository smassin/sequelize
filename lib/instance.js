...
Instance.prototype._setInclude = function(key, originalValue, options) {
  ...
  if (include.originalAttributes === undefined || include.originalAttributes.length) {
    if (association.isSingleAssociation) {
      ...
      console.log(include.keyBy)
      console.log(value)
      self[accessor] = isEmpty ? [] : include.model.bulkBuild((include.keyBy && _.isPlainObject(originalValue) ? _.values(originalValue) : value), childOptions);
      if(include.keyBy) {
